...
using TestSite1.Application.Features.ExtendedAttributes.Commands.AddEdit;
using TestSite1.Application.Features.ExtendedAttributes.Commands.Delete;
using TestSite1.Application.Features.ExtendedAttributes.Queries.Export;
using TestSite1.Application.Features.ExtendedAttributes.Queries.GetAll;
using TestSite1.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using TestSite1.Application.Features.ExtendedAttributes.Queries.GetById;
using TestSite1.Domain.Contracts;

namespace TestSite1.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
