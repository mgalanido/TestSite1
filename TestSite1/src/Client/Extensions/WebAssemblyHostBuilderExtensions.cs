...
using TestSite1.Client.Infrastructure.Authentication;
using TestSite1.Client.Infrastructure.Managers;
using TestSite1.Client.Infrastructure.Managers.ExtendedAttribute;
using TestSite1.Client.Infrastructure.Managers.Preferences;
...
namespace TestSite1.Client.Extensions
{
